...
import { CollectionPriceData, Entity, EntityType, MarketplaceInstructionType, MarketplaceTransactionEntityData, RelatedEntityData } from '../../shared/src/types'
...
export const processItem = async (collectionIds: string[]) => {
  ...
  await sendToQueue(sqs, queueUrlCollectionOS, collectionIds);
}
