 ...
 */
export async function collectionMetadataProcessorTriggerWriter(entity: Entity) {
    let trigger = new TriggerEntity<string>();    
    trigger.populate(entity.globalId, TriggerSubtype.CollectionMetadataProcessor, entity.data);
