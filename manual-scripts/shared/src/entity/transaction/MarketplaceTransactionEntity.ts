...
type MarketplaceTransactionEntity = BidTransactionEntity | AskTransactionEntity | CancelBidTransactionEntity | CancelAskTransactionEntity | ExecuteSaleTransactionEntity;