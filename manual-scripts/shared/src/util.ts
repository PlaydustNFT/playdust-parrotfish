...
export const getCollectionIds = async (mintAddress: string): Promise<string[]> => {
    console.log(`getCollectionIds: mint=${mintAddress}`);
    ...
    {
        console.log(`HandleCollection4NFT: ${JSON.stringify(entity)}`);
...
export const createMarketData4CollectionObjects = (relatedEntityData: RelatedEntityData, collectionIds: string[]): MarketData4CollectionEntity[] => {
    ...
    for (const collectionId of collectionIds) {
        console.log(`Create MarketData4Collection: CollectionId=${collectionId}`);
...
export const createOffchainMetadata4CollectionObjects = (relatedEntityData: RelatedEntityData, collectionIds: string[]): OffchainMetadata4CollectionEntity[] => {
