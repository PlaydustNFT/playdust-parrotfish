...
/**
 * @openapi
 * /auction-house/{treasuryMint}/buy-now:
 *   post:
 *     description: Transaction to buy now NFT. When bid price matches ask price, sale will execute. 
 *     tags: [Auction House]
 *     parameters:
 *       - name: treasuryMint
 *         description: treasury mint address
 ...
 *               $ref: '#/components/schemas/Uint8Array'
 */
 router.post("/:treasuryMint/buy-now", AuctionHouseController.bid);

/**
 * @openapi
 * /auction-house/{treasuryMint}/accept-bid:
 *   post:
 *     description: Transaction to accept bid
 *     tags: [Auction House]
 *     parameters:
 *       - name: treasuryMint
 *         description: treasury mint address
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/AcceptBid'
 *     responses:
 *       200:
 *         description: Buy transaction buffer
 *         content:
 ...
 *               $ref: '#/components/schemas/Uint8Array'
 */
 router.post("/:treasuryMint/accept-bid", AuctionHouseController.acceptBid);
